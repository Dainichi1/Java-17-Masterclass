package SEZIONE_06_Control_Flow.Esercizio_di_codifica_29_Paint_Job;
...
public class PaintJob {
    ...
    public static int getBucketCount (double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        double areaParete = width*height;
        double areaCoperta = extraBuckets*areaPerBucket;
        int secchiDaComprare = 0;

        if (areaCoperta < areaParete) {
            secchiDaComprare = (int) Math.ceil((areaParete / areaPerBucket) - extraBuckets);
        } return secchiDaComprare;
    }
    ...
    public static int getBucketCount (double width, double height, double areaPerBucket) {
        ...
        secchiDaComprare = (int) Math.ceil((areaParete / areaPerBucket));
        return secchiDaComprare;
    }
    ...
    public static int getBucketCount (double area, double areaPerBucket) {
        ...
        secchiDaComprare = (int) Math.ceil(area / areaPerBucket);
        return secchiDaComprare;
    }
}
